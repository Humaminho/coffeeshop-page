export default function home() {
  ...
  content.innerHTML = `<header>
    ...
    <main class = "home">
      <section>
        <h2>ARGAN<span id="coffee-color">TIN</span>A.</h2>
        ...
        <div class="contact-icons">
          ...
          <a href="https://www.google.com/maps" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
